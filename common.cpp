...
static const char* splashes[] = {
    ...
    "Путём несложных, но громоздких преобразований, очевидно, получаем:\n",
    "Для дела - по Коши, а по Гейне - для души",
    "Ну тут всё и так очевидно\n",
    "Решил со звёздочкой задачи, с каждым днём я всё богаче\n",
    "Мне уроки делать влом, в MIT куплю диплом\n",
    "Производная? Да, производная\\dots\n",
    "Дифференцировать и компьютер научить можно, а вот интегрировать — это искусство!\n"
    };
